        ...
        <h1 class=" text-black text-right">Donate</h1>
          <div class="align-text-top text-right"><p>Please help us in our noble cause to help underpriviledged children</p>
            ...
            <?php
                ...
                ?>
              as a donation.</p>
              <p>So, please help us reach our goal so that we can help during disasterous times.</p>
          </div>
      ...
      <div class="container py-5">
        ...
        <div class="row py-3">
          ...
          <div class="col-md-4 bg-light">
            ...
            <p class="text-serif text-lg text-primary">“The best way to find yourself is to lose yourself in the service of others.”</p>
            <h5 class="text-lg-right text-serif">-Mahatma Gandhi</h1>
          </div>
        </div>
      </div>
    </section>
