  ...
  <body>
    ...
    <section class="text-center pt-5 pt-lg-0" id="home">
            <div class="carousel-item drk active">
              <img class="d-block w-100 bg-transparent" src="images/child_health2.png" alt="Second slide">
    ...
    <section class="py-5">
      <div class="container py-5">
        <div class="row mb-5">
          <div class="col-lg-6">
            <p class="drop-caps">
            India is home to 46.6 million stunted children, a third of world’s total as per Global Nutrition Report 2018. Nearly half of all 
            under-5 child mortality in India is attributable to undernutrition. Any country cannot aim to attain economic and social development 
            goals without addressing the issue of malnutrition. Poor nutrition in the first 1000 days of a child’s life can also lead to stunted 
            growth, which is associated with impaired cognitive ability and reduced school and work performance. 
            </p>
            <p>
            Malnutrition in children occurs as a complex interplay among various factors like poverty, maternal health illiteracy, diseases like
             diarrhoea, home environment, dietary practices, hand washing and other hygiene practices, etc. Low birth weight, episode of diarrhoea 
             within the last 6 months and the presence of developmental delay are often associated with malnutrition in most developing nations 
             including India.
            </p>
          </div>
          <div class="col-lg-6"><img class="img-fluid" src="images/child_health1.jpg" alt=""></div>
        </div>
        <div class="row bg-light">
          <div class="col-lg-12">
            <p>Our ngo's interventions in the health sector work to improve access to quality health services for the poor and
             marginalised communities. By identifying the root causes of healthcare challenges, we work at the individual, community and systemic 
             levels to develop innovative solutions and help implement quality healthcare services. The work with community groups, collaborative
              work with government and civil society organisations include cross-cutting strategies to improve the health and nutrition status of 
              the poorest and excluded groups, particularly  children.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        ...
        <h1 class=" text-black text-right">Donate</h1>
          <div class="align-text-top text-right"><p>Please help us in our noble cause to help underpriviledged children</p>
            ...
            <?php
                ...
                $sql = "SELECT sum(donation) FROM child_healthcare_donate";
                $result = $db->query($sql);
        ...
        <div class="col-lg-6 bg-light">
          ...
          <table class="table-bordered table-primary table table-hover">
              ...
              <?php
                $sql = "SELECT name,donation FROM child_healthcare_donate order by donation desc";
                $result = $db->query($sql);
                $temp = 0;
      ...
      <div class="container py-5">
        ...
        <div class="row py-3">
          ...
          <div class="col-md-4 bg-light">
            ...
            <p class="text-serif text-lg text-primary">“We can change the world and make it a better place. It is in our hands to make a difference.”</p>
            <h5 class="text-lg-right text-serif">-Nelson Mandela</h1>
          </div>
        </div>
      </div>
    </section>
